                      ...
                      <tr v-for="(item, index) in data">
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="showEdit" tabindex="-1" aria-labelledby="#showModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="" id="editForm" @submit.prevent="editData(item)">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="mb-3">
                                                    <label for="password_confirm" class="form-label">Password Confirmation :</label>
                                                    <input type="password" class="form-control" id="password_confirm" :value="item.password_confirm">
                            ...
                            <form action="" id="deleteForm" @submit.prevent="deleteData(item)" class="d-inline-block">
                                @method('DELETE')
                                <button type="submit" class="mx-1 btn btn-danger"><i class='bx bx-trash'></i></button>
                            </form>
                        </td>
                        <td >
