            ...
            methods: {
                ...
                getData(param) {
                    if (param) {
                        ...
                        this.data = fetch('https://magang.crocodic.net/ki/kelompok_3/tour-app/public/api/admin?search='+ param +'', {
                            method: 'get',
                            headers: {
                ...
                bulkDelete() {
                    ...
                    if (check) {
                        ...
                        this.newData = fetch(`https://magang.crocodic.net/ki/kelompok_3/tour-app/public/api/bulk-admin`, requestOption)
                        .then((response) => {
                            // convert response
                            return response.json()
                        })
