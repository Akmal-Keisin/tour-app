...
<head>
    ...
    <title>{{ (Request::is('mynotes-users*') ? 'Users' : 'Admins') }}</title>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="@if (Session::get('auth')['data']['image'] == null) {{ env('APP_URL') . '/images/default.png' }} @else {{ Session::get('auth')['data']['image'] }} @endif">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kelas Industri 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
